function[] = ana_AS_postproc_Dup15q()
%%
clearvars
dbstop if error

td = dir('./Dup15q_controls/Imported/Dup15q_butterHP_firLP/Clean/*.mat');
tdpath = './Dup15q_controls/Imported/Dup15q_butterHP_firLP/Clean/';
stNDX = 1;
...
DIRRESULT = './2021_analysis/postprocessed/Dup15q/'; if ~exist(DIRRESULT), mkdir(DIRRESULT), end
...
%% Fix sampleinfo and sleep labels

data.sampleinfo(1,2) = size(data.trial{1},2); % fix bug from preproc script
% sleep is automatically everything from the second trial
