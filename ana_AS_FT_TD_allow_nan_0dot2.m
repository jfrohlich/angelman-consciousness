...
switch sleep
    case true
        DIRRESULT = './2021_analysis/freq_out/TD/nan=0.2/sleep/'; if ~exist(DIRRESULT), mkdir(DIRRESULT), end
        ntrl = 2;
    case false
        DIRRESULT = './2021_analysis/freq_out/TD/nan=0.2/wake/'; if ~exist(DIRRESULT), mkdir(DIRRESULT), end
        ntrl = 1;
end
