...
switch sleep
    case true
        DIRRESULT = './2021_analysis/Dup15q_output/wPLI/sleep/'; if ~exist(DIRRESULT), mkdir(DIRRESULT), end   
        ntrl = 2;
    case false       
        DIRRESULT = './2021_analysis/Dup15q_output/wPLI/wake/'; if ~exist(DIRRESULT), mkdir(DIRRESULT), end  
        ntrl = 1; 
end
