...
switch sleep
    case true
        DIRRESULT = './2021_analysis/Dup15q_output/LZCv/sleep/'; if ~exist(DIRRESULT), mkdir(DIRRESULT), end    
        ntrl = 2;
    case false       
        DIRRESULT = './2021_analysis/Dup15q_output/LZCv/wake/'; if ~exist(DIRRESULT), mkdir(DIRRESULT), end     
        ntrl = 1;
end
