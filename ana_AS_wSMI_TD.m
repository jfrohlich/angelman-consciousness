...
switch sleep
    case true
        DIRRESULT = './2021_analysis/TD_output/wSMI/sleep/'; if ~exist(DIRRESULT), mkdir(DIRRESULT), end    
        ntrl = 2;
    case false       
        DIRRESULT = './2021_analysis/TD_output/wSMI/wake/'; if ~exist(DIRRESULT), mkdir(DIRRESULT), end     
        ntrl = 1;
end
...
for ifile = 1:length(files)
    ...
    % downsample to 125 Hz prior to wSMI 
