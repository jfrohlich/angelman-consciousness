function  varargout = myresample(varargin)
%
%%% Modified from native Matlab 2018b function by Joel Frohlich 
%
% Forces filter kernel, p, and q to be double to avoid bug. Other Matlab
% users have also complained about this problem: https://ch.mathworks.com/
% matlabcentral/answers/404624-matlab-coder-error-with-resample-function
%
